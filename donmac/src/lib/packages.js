...
export const PACKAGES = {
  mtn_mashup: {
    ...
    color: '#FFCC00', textColor: '#4A3700', bgColor: '#FFFBEB',
    borderColor: '#FDE68A',
    gradientFrom: '#FFCC00', gradientTo: '#F59E0B',
    items: [
  ...
  telecel: {
    ...
    validity: '60 days',
    ghdata_type: 'telecel',
    color: '#E40521', textColor: '#fff', bgColor: '#FFF1F2',
    borderColor: '#FECDD3',
    gradientFrom: '#E40521', gradientTo: '#9F1239',
    items: [
  ...
  airtel_premium: {
    ...
    validity: '60 days',
    ghdata_type: 'at',
    color: '#1d4ed8', textColor: '#fff', bgColor: '#EFF6FF',
    borderColor: '#BFDBFE',
